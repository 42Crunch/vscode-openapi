(function () {
  ...
  setTimeout(() => {
    ...
    document.body
      .querySelectorAll(".focus-line")
      .forEach((e) => e.addEventListener("click", focusLine));
    ...
    document.body
      .querySelectorAll(".go-full-report")
      .forEach((e) => e.addEventListener("click", goFullReport));

    document.body
      .querySelectorAll(".issue-id")
      .forEach((e) => e.addEventListener("click", copyIssueId));

    document.body
      .querySelectorAll("div.dropdown")
