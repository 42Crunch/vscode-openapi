...
ra/ro: true`);
	  ...
	  test('yaml getKeyRange()', () => {
		...
		assert.deepEqual(root.find('/paths/~1%7BcomicId%7D~1info.0.json/get/parameters/0/required').getKeyRange(), [1113, 1121]);
	  ...
	  test('yaml getValueRange()', () => {
		...
		assert.deepEqual(root.find('/paths/~1%7BcomicId%7D~1info.0.json/get/parameters/0/required').getValueRange(), [1123, 1127]);
