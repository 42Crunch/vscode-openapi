...
export function MainContainer() {
  ...
  // Start sending requests only after all data from IDE is available
  if (platformApiToken && targetFileName && tagData) {
    return <MainSubContainer></MainSubContainer>;
  } else {
    return <></>;
  }
}

export function MainSubContainer() {
  const {
    data: categoryList,
...
function getTagDataToSave(
  ...
  tagData[targetFileName] = tagEntries;
  return tagData;
}
